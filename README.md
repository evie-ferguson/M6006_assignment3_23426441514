...
This project explores the predictors of divorce using a simulated dataset of 5,000 observations. The main goal is to assess whether internal relationship factors (e.g., communication, infidelity, trust) or structural factors (e.g., age at marriage, education, income) are stronger predictors of divorce. The analysis includes:
...
summative_divorce.ipynb – Jupyter notebook with full data analysis, model building, and interpretation
summative-app.py – Shiny app script for interactive prediction and visualization
